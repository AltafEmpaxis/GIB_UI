...
import { RawGenevaData } from 'components/Table/Columns/Columns';
...
const GenevaTaxLots = () => {
  ...
  const fetchRawGenevaData = useCallback(async () => {
    try {
      const response = await axios.get('/api/NormaliseFile/GetRawGenevaData/raw-geneva-data', {
        params: {
          userId: user?.user_id,
      ...
      console.error('Error fetching raw APX data:', err);
      throw err;
    }
  ...
  return (
    <>
      <title>APX Raw Data</title>
      <meta name="description" content="View and analyze raw tax lots data from APX system" />
      <meta property="og:title" content="APX Raw Data" />
      <meta property="og:description" content="View and analyze raw tax lots data from APX system" />
