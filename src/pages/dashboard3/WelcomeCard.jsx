...
function WelcomeCard({ isLoading = false }) {
  ...
  // GIB brand colors
  const primaryGreen = '#007B5F'; // GIB primary green
  const secondaryBlue = '#0F345E'; // GIB dark blue

  const bgColor =
    theme.palette.mode === 'dark'
      ? `linear-gradient(75deg, ${alpha(secondaryBlue, 0.85)} 0%, ${secondaryBlue} 100%)`
      : `linear-gradient(75deg, ${primaryGreen} 0%, ${alpha(secondaryBlue, 0.85)} 100%)`;
