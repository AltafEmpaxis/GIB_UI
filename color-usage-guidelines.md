...
# GIB Brand Colour Guidelines

This document explains how to use the GIB brand colours according to the official brand guidelines.

## GIB Brand Palette Presets

| Name        | Hex          | Pantone                | CMYK                       | RGB               | Usage                                              |
| ----------- | ------------ | ---------------------- | -------------------------- | ----------------- | -------------------------------------------------- |
| GIB Yellow  | `#FFC72C`    | Pantone® 123C          | C:0 M:20 Y:100 K:0         | R:255 G:199 B:44  | Main brand colour, always present in brand layouts |
...
| Gold Colour | Pantone 873C | Pantone® 873C          | With gloss aqueous coating | -                 | Special-print/gloss coatings only                  |
...
## Brand Colour Philosophy

GIB's main brand colour is the GIB Yellow. This deep, rich yellow is a colour that holds its own and denotes optimism and trust. It sits alongside a careful selection of greys that add versatility and sophistication to the overall visual system.
...
The GIB Yellow is mainly an accent colour but is an integral part of the brand language. Its minimal use is further enhanced by the wide range of greys, which offset the Yellow and truly allow it to stand out. We strongly recommend that no matter how the colours are combined across communications, the GIB Yellow should always be present.
...
* Hover states: Use dark variant of the button colour (ffb300 for yellow buttons)
...
For charts and graphs, use the following colour distribution:
...
* Error state: Error colour (#f44336)
* Success state: Success colour (#4caf50)
* Placeholder text: Medium Grey (#A2AAAD)

### Alerts & Notifications

* Info: Info colour (#2196f3)
* Success: Success colour (#4caf50)
* Warning: GIB Yellow (#FFC72C) or Warning colour (#ff9800)
* Error: Error colour (#f44336)

### Brochures & Advertising

When designing brochures and advertising materials:

* Use GIB Yellow as an accent colour
* Maintain white space with Dark Grey text
* Include the GIB logo prominently
* Use imagery that complements the colour palette
...
In the theme configuration, colours are mapped as follows:

* Dark Grey (#53565A) → primary colour
* GIB Yellow (#FFC72C) → secondary colour
* Medium Grey (#A2AAAD) → tertiary colour
* Light Grey (#D9D9D6) → grey.200

### Usage in Code

```jsx
// Using theme colours in styled components
...
// Chart component with GIB colours
